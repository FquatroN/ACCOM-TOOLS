...
grant execute on function public.get_bi_sales_pivot_payload(integer, integer)
  to anon, authenticated, service_role;

create index if not exists import_fdm_sales_sales_bi_pivot_idx
  on public.import_fdm_sales (sale_date) include (sale_item, total);
