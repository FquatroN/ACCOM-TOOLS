...
const APP_FEATURES = ["communications", "guests", "cash", "lost-found", "reviews", "maintenance", "groups", "services", "shopping", "hours", "bakery", "laundry", "backoffice", "financial-docs", "business-intelligence", "guests-bi"];
const SETTINGS_FEATURES = ["general", "communications", "guests", "financial-docs", "cash", "reviews", "maintenance", "groups", "services", "shopping", "hours", "bakery", "laundry", "admin-users"];
