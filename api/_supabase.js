...
const APP_FEATURES = ["communications", "guests", "cash", "lost-found", "reviews", "maintenance", "groups", "services", "shopping", "hours", "bakery", "laundry", "backoffice", "financial-docs", "financial-reconciliation", "import-data", "bank-accounts", "fdm-accounts", "business-intelligence", "guests-bi", "bookings-bi", "financial-bi", "sales-bi"];
const SETTINGS_FEATURES = ["general", "communications", "guests", "financial-docs", "import-data", "financial-reconciliation", "bi-settings", "cash", "reviews", "maintenance", "groups", "services", "shopping", "hours", "bakery", "laundry", "admin-users"];
