...
const APP_FEATURES = ["communications", "lost-found", "reviews", "groups", "services", "shopping"];
const SETTINGS_FEATURES = ["communications", "reviews", "groups", "services", "shopping", "admin-users"];
