...
const APP_FEATURES = ["communications", "lost-found", "reviews", "groups", "services", "shopping", "bakery"];
const SETTINGS_FEATURES = ["communications", "reviews", "groups", "services", "shopping", "bakery", "admin-users"];
